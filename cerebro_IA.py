...
with st.sidebar:
    ...
    st.session_state.modo_ia = "✨ InkaDrill (Internet)"
...
if conexion_exitosa:
    ...
    if pestaña == "Chat Asistente Operativo":
        if st.session_state.modo_ia == "🔱 InkaDrill IA (Carpeta Drive)":
            ...
            st.markdown("<h1 style='text-align: center; color: #4285f4; font-weight: 600; font-size: 46px; margin-top: 50px; margin-bottom: 5px;'>InkaDrill IA</h1>", unsafe_allow_html=True)
