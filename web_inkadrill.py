...
st.set_page_config(page_title="InkaDrill", page_icon="https://github.com/jeanventocilla13-cpu/intranet-inkadrill/blob/main/imagen%20logo%20inkadrill.png?raw=true", layout="wide")
